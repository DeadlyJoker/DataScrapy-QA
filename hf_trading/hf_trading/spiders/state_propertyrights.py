...
from hf_trading.items import StatePropertyRightsItem


class StatePropertyrightsSpider(scrapy.Spider):
    name = "state_propertyrights"
    allowed_domains = ["ggzy.hefei.gov.cn"]
    start_urls = ["https://ggzy.hefei.gov.cn//jyxx/002003/002003001/moreinfo_jyxxgg2.html",   # 出让公告及后续流程
                  "https://ggzy.hefei.gov.cn/jyxx/002003/002003007/moreinfo_jyxx4.html"       # 项目登记
                  ]     # 国有产权
    ...
    def parse(self, response):
        ...
        """
        # 模拟点击招标计划链接
        item = StatePropertyRightsItem()
        item['original_website'] = 'https://ggzy.hefei.gov.cn//jyxx/002003/002003001/moreinfo_jyxxgg2.html'  # 来源网站
        item['project_big_category'] = '国有产权'  # 项目大分类
