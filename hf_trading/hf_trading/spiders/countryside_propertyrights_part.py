...
from hf_trading.items import CountrysidePropertyrightsPartItem


class CountrysidePropertyrightsPartSpider(scrapy.Spider):
    name = "countryside_propertyrights_part"
    allowed_domains = ["ggzy.hefei.gov.cn"]
    start_urls = ["https://ggzy.hefei.gov.cn/jyxx/002007/002007001/moreinfo_jyxxgg2.html",    # 招标公告
                  "https://ggzy.hefei.gov.cn/jyxx/002007/002007002/moreinfo_jyxxgg2.html",    # 补充变更公告
                  "https://ggzy.hefei.gov.cn/jyxx/002007/002007003/moreinfo_jyxxgs2.html"     # 结果公告
                  ]     # 农村产权
    ...
    def parse(self, response):
        ...
        """
        # 模拟点击招标计划链接
        item = CountrysidePropertyrightsPartItem()
        item['original_website'] = 'https://ggzy.hefei.gov.cn/jyxx/002007/engineer2.html'  # 来源网站
        item['project_big_category'] = '农村产权'  # 项目大分类
