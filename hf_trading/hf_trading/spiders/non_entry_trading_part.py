...
from hf_trading.items import OtherTradingPartItem


class NonEntryTradingPartSpider(scrapy.Spider):
    name = "non_entry_trading_part"
    allowed_domains = ["ggzy.hefei.gov.cn"]
    start_urls = ["https://ggzy.hefei.gov.cn/jyxx/002008/002008001/moreinfo_jyxx.html",    # 招标公告
                  "https://ggzy.hefei.gov.cn/jyxx/002008/002008002/moreinfo_jyxx.html",    # 答疑变更
                  "https://ggzy.hefei.gov.cn/jyxx/002008/002008003/moreinfo_jyxx.html"     # 结果公告
                  ]
    ...
    def parse(self, response):
        ...
        """
        # 模拟点击招标计划链接
        item = OtherTradingPartItem()
        item['original_website'] = 'https://ggzy.hefei.gov.cn/jyxx/002008/engineer.html'  # 来源网站
        item['project_big_category'] = '非进场交易项目'  # 项目大分类
