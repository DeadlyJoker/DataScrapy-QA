...
from hf_trading.items import GovProcurementPartItem


class GovProcurementPartSpider(scrapy.Spider):
    name = "gov_procurement_part"
    allowed_domains = ["ggzy.hefei.gov.cn"]
    start_urls = ["https://ggzy.hefei.gov.cn//jyxx/002002/002002001/moreinfo_jyxxgg2.html",   # 采购公告以及后续流程
                  # "https://ggzy.hefei.gov.cn/jyxx/002002/002002013/moreinfo_jyxx4.html"       # 项目登记
                  ]  # 政府采购
    ...
    def parse(self, response):
        ...
        """
        # 模拟点击招标计划链接
        item = GovProcurementPartItem()
        item['original_website'] = 'https://ggzy.hefei.gov.cn/jyxx/002002/engineer2.html'  # 来源网站
        item['project_big_category'] = '政府采购'  # 项目大分类
