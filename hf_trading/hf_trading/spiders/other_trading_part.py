...
class OtherTradingPartSpider(scrapy.Spider):
    name = "other_trading_part"
    allowed_domains = ["ggzy.hefei.gov.cn"]
    start_urls = ["https://ggzy.hefei.gov.cn//jyxx/002013/002013001/moreinfo_jyxxgg2.html"]       # 其他交易 --- 招标公告
    ...
    def parse(self, response):
        ...
        item['original_website'] = 'https://ggzy.hefei.gov.cn/jyxx/002013/engineer2.html'  # 来源网站
        item['project_big_category'] = '其他交易'  # 项目大分类
