...
from hf_trading.items import LandMiningRightsPartItem


class LandMiningRightsSpider(scrapy.Spider):
    name = "land_mining_rights_part"
    allowed_domains = ["ggzy.hefei.gov.cn"]
    start_urls = ["https://ggzy.hefei.gov.cn//jyxx/002004/002004001/moreinfo_jyxxgg2.html"]    # 土地矿权 --- 招标公告
    ...
    def parse(self, response):
        ...
        """
        # 模拟点击招标计划链接
        item = LandMiningRightsPartItem()
        item['original_website'] = 'https://ggzy.hefei.gov.cn/jyxx/002004/engineer2.html'  # 来源网站
        item['project_big_category'] = '土地矿权'  # 项目大分类
